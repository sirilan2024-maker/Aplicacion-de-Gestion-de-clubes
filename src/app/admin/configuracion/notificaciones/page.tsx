        ...
        <div className="flex items-center border-b border-slate-200 overflow-x-auto no-scrollbar max-w-full">
          <div className="flex items-center gap-2 shrink-0">
            ...
            <Link
              ...
              className="px-4 py-2.5 text-xs md:text-sm font-bold text-indigo-600 border-b-2 border-indigo-600 transition-colors flex items-center gap-2 whitespace-nowrap shrink-0"
            >
