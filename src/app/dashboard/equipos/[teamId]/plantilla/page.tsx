                ...
                players.map((player) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 border-y-2 border-slate-700 group-hover:border-blue-600">
                        <span
                          className={`text-xs font-semibold px-3 py-1.5 rounded-full inline-flex items-center capitalize border-2 border-slate-700 ${
                      ...
                      <td className="px-6 py-4 text-slate-900 border-y-2 border-slate-700 group-hover:border-blue-600">
                        {player.birth_date ? (
                          <div className="flex flex-col">
                      ...
                      <td className="px-6 py-4 text-slate-600 font-medium border-y-2 border-slate-700 group-hover:border-blue-600">
                        <div className="flex flex-col">
          ...
          players.map((player) => {
            ...
            return (
              <div 
                ...
                className={`bg-white rounded-2xl p-6 shadow-md border-2 border-slate-700 hover:border-blue-600 hover:shadow-xl relative overflow-hidden cursor-pointer active:scale-[0.98] transition-all border-l-8 ${esEntrenador ? 'border-l-blue-500' : 'border-l-emerald-500'}`}
              >
