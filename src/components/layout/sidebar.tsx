            ...
            <div className="min-w-0 flex-1 flex flex-col justify-center">
              {clubInfo ? (
                <>
                  ...
                  <p className={cn("text-[10px] font-semibold tracking-wide uppercase mt-1 flex items-center gap-1.5 whitespace-nowrap", isViewingHistorical ? "text-amber-400 font-extrabold" : (isAdmin ? "text-slate-400" : "text-gray-400"))}>
