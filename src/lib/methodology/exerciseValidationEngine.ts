...
/**
 * Valida estrictamente un ejercicio individual antes de su persistencia en public.banco_ejercicios
 */
export function validateExercise(input: any): ExerciseValidationResult {
  ...
  // 9. Validación de Categoría de Edad
  ...
  // 11. Regla de Coherencia de Vuelta a la Calma (Invariante Metodológico)
  ...
  const sanitized: ExerciseImportInput = {
    ...
    tactical_board_data: input.tactical_board_data || null
  };
